...
//  Weather_iOS
//
//  Created by Dima Pechenenko on 12.09.2022.
//
...
extension Forecast {
    ...
    static let hourly: [Forecast] = [
        ...
        Forecast(date: .init(timeIntervalSinceNow: hour * 2), weather: .rainy, probability: 30, temperature: 18, high: 24, low: 18, location: "Montreal, Canada"),
        Forecast(date: .init(timeIntervalSinceNow: hour * 3), weather: .rainy, probability: 30, temperature: 19, high: 24, low: 18, location: "Montreal, Canada"),
        Forecast(date: .init(timeIntervalSinceNow: hour * 4), weather: .rainy, probability: 30, temperature: 19, high: 24, low: 18, location: "Montreal, Canada")
    ]
    ...
    static let daily: [Forecast] = [
        ...
        Forecast(date: .init(timeIntervalSinceNow: day * 3), weather: .stormy, probability: 50, temperature: 19, high: 24, low: 18, location: "Montreal, Canada"),
    ...
    static let cities: [Forecast] = [
        ...
        Forecast(date: .now, weather: .tornado, probability: 0, temperature: 23, high: 26, low: 16, location: "Tennesse, USA"),
    ]
}
